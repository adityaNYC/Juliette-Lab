...
// scripts/india.js
function signUpWith(platform) {
    // Add your logic for social login here
...
$(function() {
    ...
    let petNames = [
        ["tank", ["Rein", "Bulbasaur", "Meow", "Pichu"]],
        ["dps", ["Charlizard", "Pikachu", "Charmender"]],
        ["support", ["ash", "brooke", "Savannah"]],
    ];
